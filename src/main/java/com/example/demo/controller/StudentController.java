...
public class StudentController {
	...
	@PostMapping("/updateStudentDetails/{studentId}")
	public Student updateStudentDetails(@PathVariable Long studentId, @RequestBody Student student) {
		return studentService.updateStudentDetailById( studentId ,student);
	}
	@DeleteMapping("/deletingStudentDetails")
	public Student deleteStudentDetails(Long studentId) {
